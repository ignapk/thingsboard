...
public class TbHttpClient {
    ...
    public void processMessage(TbContext ctx, TbMsg msg,
        ...
        log.warn("HELLO THERE processMessage headers: {}", headers);
        ...
        future.addCallback(new ListenableFutureCallback<>() {
            ...
            public void onFailure(Throwable throwable) {
                if (throwable instanceof RestClientResponseException &&
                        ...
                        CredentialsType.BASIC == config.getCredentials().getType()) {
    ...
    private void handleDigestChallenge(TbContext ctx, TbMsg msg,
        ...
        log.warn("HELLO THERE handleDigestChallenge wwwAuthenticateHeader: {}", wwwAuthenticateHeader);
        if (wwwAuthenticateHeader != null && wwwAuthenticateHeader.startsWith("Digest")) {
            BasicCredentials digestCredentials = (BasicCredentials) config.getCredentials();
    ...
    private void retryWithDigestAuth(TbContext ctx, TbMsg msg,
        ...
        log.warn("HELLO THERE retryWithDigestAuth headers: {}", headers);
        HttpMethod method = HttpMethod.valueOf(config.getRequestMethod());
        HttpEntity<String> entity;
        if (HttpMethod.GET.equals(method) || HttpMethod.HEAD.equals(method) ||
                HttpMethod.OPTIONS.equals(method) || HttpMethod.TRACE.equals(method) ||
    ...
    private String buildDigestAuthHeader(BasicCredentials credentials, String nonce,
